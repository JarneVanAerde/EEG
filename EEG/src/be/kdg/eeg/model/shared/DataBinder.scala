...
/**
  ...
  */
final class DataBinder(val fileForStimulus: String) {
  private val MIN_CONTACT_POINT_RANGE: Int = 3
  ...
  /**
    ...
    */
  private def getCodePointsForStimulusRow(row: Array[String], row_values: Vector[ContactPointValue] = Vector[ContactPointValue](), counter: Int = MIN_CONTACT_POINT_RANGE): Vector[ContactPointValue] = {
    if (counter > MAX_CONTACT_POINT_RANGE) return row_values
